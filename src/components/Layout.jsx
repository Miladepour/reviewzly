    ...
    <div className="app-container">
      ...
      <aside className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
        ...
        <nav className="flex flex-col gap-1 sidebar-content">
          <NavLink to="/dashboard" onClick={closeSidebar} className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`} end>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
            Dashboard
          </NavLink>
          <NavLink to="/dashboard/inbox" onClick={closeSidebar} className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
            Inbox
          </NavLink>
          <NavLink to="/dashboard/campaigns" onClick={closeSidebar} className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
          ...
          <NavLink to="/dashboard/clients" onClick={closeSidebar} className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
            Clients Directory
          </NavLink>
          <NavLink to="/dashboard/reviews" onClick={closeSidebar} className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
          ...
          <NavLink to="/dashboard/sms" onClick={closeSidebar} className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
            SMS Hub
          </NavLink>
          <NavLink to="/dashboard/settings" onClick={closeSidebar} className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
          ...
          <NavLink to="/dashboard/profile" onClick={closeSidebar} className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
        ...
        <div className="mt-auto flex flex-col gap-2 pt-6">
          <button onClick={() => { closeSidebar(); navigate('/dashboard/plan'); }} className="btn-primary" style={{ padding: '0.875rem', width: '100%', marginBottom: '1.5rem', justifyContent: 'center', cursor: 'pointer' }}>Manage Plan</button>
          
          <NavLink to="/dashboard/help" onClick={closeSidebar} className={({ isActive }) => `nav-link mt-8 ${isActive ? 'active' : ''}`}>
          ...
          {isSuperAdmin && (
            <NavLink to="/dashboard/admin" onClick={closeSidebar} className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`} style={{ color: 'var(--primary)', fontWeight: 700 }}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
              Super Admin Panel
            </NavLink>
          )}
      ...
      <main className="main-wrapper">
        ...
        <div className="top-nav">
          ...
          <div className="top-nav-main flex items-center gap-6 flex-wrap">
